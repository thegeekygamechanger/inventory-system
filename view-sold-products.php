        ...
        <div class="row align-items-center h-100" >
          ...
          <div class="col-10 mx-auto">
                ...
                <?php
                  ...
                  if(mysqli_num_rows($ret)==0)
                  {
                      echo "<h1 class='text-center'>No,Products available to show.</h1><div class='col'><form action='dashboard.php'><button type='submit' class='btn action-btn btn-block mt-4'>Done</button></form></div>";
