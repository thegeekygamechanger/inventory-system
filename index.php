    ...
    <div class="container h-100">
        <div class="row text-center align-items-center h-100 " >
            ...
            <div class="col-lg-12 center team-menbers">
                <img src="images/hk.jpg" class="rounded-circle" width="120" height="120">
                <h6 class="m-1">Harsh kumar</h6>
                <a href="https://github.com/thegeekygamechanger" class="theme-color">Harsh kumar</a>
            </div>
